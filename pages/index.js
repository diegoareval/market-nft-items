export default function Home() {
  return (
      <div className="max-w-sm rounded overflow-hidden shadow-lg">
          <img className="w-full" src="https://www.adobe.com/content/dam/cc/us/en/creativecloud/photography/discover/real-estate-photography/real-estate-photography_P1_900x420.jpg.img.jpg" alt="Sunset in the mountains"/>
